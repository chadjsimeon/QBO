...
router.post("/auth/register", async (req, res) => {
  ...
  await db.insert(accounts).values([
    ...
    { organizationId: org.id, code: "1100", name: "Accounts Receivable",   type: "ASSET",     subtype: "receivable",   sortOrder: 130, systemRole: "AR" as const },
    ...
    { organizationId: org.id, code: "2010", name: "Accounts Payable",      type: "LIABILITY", subtype: "payable",      sortOrder: 210, systemRole: "AP" as const },
    { organizationId: org.id, code: "2100", name: "Sales Tax Payable",     type: "LIABILITY", subtype: "tax",          sortOrder: 220, systemRole: "SALES_TAX_PAYABLE" as const },
    ...
    { organizationId: org.id, code: "3200", name: "Retained Earnings",     type: "EQUITY",    subtype: "retained",     sortOrder: 320, systemRole: "RETAINED_EARNINGS" as const },
