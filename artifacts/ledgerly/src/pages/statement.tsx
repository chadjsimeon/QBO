      ...
      <div className="no-print mb-6 flex items-end justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Open-item statement of a customer's account.
          </p>
        </div>
        {statement && (
            ...
            <div className="mb-6 flex items-start justify-between">
              ...
              <div className="text-right text-sm">
                ...
                {statement.customer.email && (
                  <div className="text-muted-foreground">{statement.customer.email}</div>
                )}
              ...
              <TableBody>
                ...
                {statement.entries.map((e, i) => (
                  <TableRow key={i}>
                    ...
                    <TableCell className="text-right tabular-nums">
                      {e.chargeCents ? formatCents(e.chargeCents) : ""}
                    </TableCell>
                    <TableCell className="text-right tabular-nums">
                      {e.creditCents ? formatCents(e.creditCents) : ""}
                    </TableCell>
                    <TableCell className="text-right tabular-nums">
